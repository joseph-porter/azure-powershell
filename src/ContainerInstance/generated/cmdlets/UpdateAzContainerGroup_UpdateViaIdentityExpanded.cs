...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20210701.IResource _resourceBody= new Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20210701.Resource();

        /// <summary>The Resource model definition.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20210701.IResource ResourceBody { get => this._resourceBody; set => this._resourceBody = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20210701.IResourceTags Tag { get => ResourceBody.Tag ?? null /* object */; set => ResourceBody.Tag = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ContainerGroupsUpdateViaIdentity(InputObject.Id, ResourceBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ContainerGroupsUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ContainerGroupName ?? null, ResourceBody, onOk, onDefault, this, Pipeline);
                    }
