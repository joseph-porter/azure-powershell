...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20210701
{
    ...
    public partial class InitContainerPropertiesDefinition
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20210701.IInitContainerPropertiesDefinition.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20210701.IInitContainerPropertiesDefinition.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20210701.IInitContainerPropertiesDefinition FromJson(Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonNode node)
        {
        ...
        internal InitContainerPropertiesDefinition(Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonObject json)
        {
            ...
            {_instanceView = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonObject>("instanceView"), out var __jsonInstanceView) ? Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20210701.InitContainerPropertiesDefinitionInstanceView.FromJson(__jsonInstanceView) : InstanceView;}
            ...
            {_environmentVariable = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonArray>("environmentVariables"), out var __jsonEnvironmentVariables) ? If( __jsonEnvironmentVariables as Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20210701.IEnvironmentVariable[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20210701.IEnvironmentVariable) (Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20210701.EnvironmentVariable.FromJson(__p) )) ))() : null : EnvironmentVariable;}
            {_volumeMount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonArray>("volumeMounts"), out var __jsonVolumeMounts) ? If( __jsonVolumeMounts as Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20210701.IVolumeMount[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__l, (__k)=>(Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20210701.IVolumeMount) (Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20210701.VolumeMount.FromJson(__k) )) ))() : null : VolumeMount;}
            AfterFromJson(json);
        }
