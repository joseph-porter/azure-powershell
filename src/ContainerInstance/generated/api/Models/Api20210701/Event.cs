...
namespace Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20210701
{
    ...
    public partial class Event :
        Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20210701.IEvent,
        Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20210701.IEventInternal
    {
        ...
        int? Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20210701.IEventInternal.Count { get => this._count; set { {_count = value;} } }

        /// <summary>Internal Acessors for FirstTimestamp</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20210701.IEventInternal.FirstTimestamp { get => this._firstTimestamp; set { {_firstTimestamp = value;} } }

        /// <summary>Internal Acessors for LastTimestamp</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20210701.IEventInternal.LastTimestamp { get => this._lastTimestamp; set { {_lastTimestamp = value;} } }

        /// <summary>Internal Acessors for Message</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20210701.IEventInternal.Message { get => this._message; set { {_message = value;} } }

        /// <summary>Internal Acessors for Name</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20210701.IEventInternal.Name { get => this._name; set { {_name = value;} } }

        /// <summary>Internal Acessors for Type</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ContainerInstance.Models.Api20210701.IEventInternal.Type { get => this._type; set { {_type = value;} } }
