...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added a DataFlowEnableQuickReuse argument for the ''Set-AzDataFactoryV2IntegrationRuntime'' cmdlet to enable quick reuse of clusters in next pipeline activities.
